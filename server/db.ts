...
type PublishedStudioSuit = { id: number; productHandle: string; title: string; description: string; productType: string; sizes: { label: string; available: boolean }[]; regularPrice: string; salePrice: string | null; publishedAt: string; updatedAt: string };
